...
public class NPCBase : MonoBehaviour
{
    ...
    public List<Sprite> goodNPCSprites;    // Sprites para NPCs buenos
    public List<Sprite> badNPCSprites;     // Sprites para NPCs malos
    ...
    private void AssignRandomSprite()
    {
        ...
        List<Sprite> spriteList = isGoodNPC ? goodNPCSprites : badNPCSprites;
